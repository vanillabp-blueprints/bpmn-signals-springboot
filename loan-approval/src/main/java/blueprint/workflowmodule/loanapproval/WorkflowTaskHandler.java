 ...
 *
 * <p>
 * A signal event needs nothing here. Only tasks are wired to code, and a catch event is
 * not one: the workflow simply carries on, and the task behind the event is what the
